...
function fixParsedEvent(parsedEvent) {
  ...
  if (parsedEvent.siteId === 's-00000005' ||
      ...
      parsedEvent.pageUrl.match(/https?:\/\/\d/) ||
      parsedEvent.pageUrl.match(/https?:\/\/proxy\./)) {
  ...
  else if (parsedEvent.source ? parsedEvents.source === 'extension' : EXTENSION_IDS.has(parsedEvent.siteId)) {
