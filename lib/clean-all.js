    ...
    input
      ...
      .on('finish', () => {
        ...
        const percentCompleted = (100 * numFilesCompleted / config.numDates).toFixed(1),
          rejectedEventsInfo = rejectedEventCounter[dateIndex] + '/' + eventCounter[dateIndex] + ' = ' +
            (100 * rejectedEventCounter[dateIndex] / eventCounter[dateIndex]).toPrecision(1) + '% rejected';
